...
const About = () => {
  return (
    <div className="relative h-auto w-full flex overflow-hidden justify-center">
      ...
      <div className="relative z-10 flex w-full lap:p-[80px] mob:p-[40px] tab:p-[60px] desk2:p-[120px] desk3:p-[140px] desk3:pl-0 desk3:pr-0 desk2:pl-0 desk2:pr-0 desk1:p-[100px] font-roboto tab:flex-row tab:w-[648px] tab:pr-0 tab:pl-0 mob:flex-col-reverse gap-8 lap:gap-10 items-center desk1:w-[1065px] lap:w-[847px] lap:pl-0 lap:pr-0 desk1:pl-0 desk1:pr-0 mob:w-[295px] mob:pl-0 mob:pr-0">
      
      <div className="mob:w-full overflow-hidden mob:h-[200px] tab:h-[240px] lap:w-[600px] desk1:h-[320px] desk2:w-[540px] desk3:w-[800px] desk3:h-[300px]">
        <img
          src={Me}
          alt="M-Image"
        ...
        <div className="flex flex-col w-auto">
          ...
          <h3 className="lab:text-[16px] mob:text-[12px] font-normal text-white mb-3 text-justify desk3:text-[16px]">
          ...
          <h3 className="lab:text-[16px] mob:text-[12px] font-normal text-white mt-2 text-justify desk3:text-[16px]">
