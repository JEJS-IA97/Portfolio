      ...
      <div className="mb-[-2px] relative lap:h-[480px] mob:h-[310px] tab:h-[365px] bg-cover bg-no-repeat flex justify-center items-center w-full">
        ...
        <div className="z-10 items-center flex flex-grow w-full lap:p-[80px] mob:p-[40px] tab:p-[60px] h-full mt-[100px] ">
          <div className="flex flex-col top-0 absolute z-20 mob:mt-[95px] tab:mt-[160px] lap:mt-[215px]">
            <h1 className="lap:text-[48px] mob:text-[24px] tab:text-[34px] font-bold text-white mb-2 lap:mb-6 mob:w-[160px] tab:w-[385px] lap:w-[700px] leading-7">
            ...
            <h2 className="z-20 lap:text-[14px] mob:text-[12px] tab:text-[13px] tab:w-[385px] lap:w-[700px] font-normal text-white mob:w-[160px]">
