...
const Skills = () => {
    ...
    <div className="font-roboto relative h-auto w-full flex overflow-hidden mt-[-1px]">
      ...
      />
        <div className="relative flex z-10 flex-col items-center w-full lap:p-[80px] desk1:p-[100px] mob:p-[40px] desk2:p-[120px] tab:p-[60px] gap-y-[40px] desk3:p-[140px] justify-center">
            <h2 className="text-[24px] desk1:text-[26px] font-bold text-white">My Skills</h2>
            <div className="grid lap:grid-cols-5 tab:grid-cols-4 mob:grid-cols-3 mob:gap-[25px] tab:gap-[32px] lap:gap-[40px] desk3:tab:grid-cols-6">
              {skills.map(object => (
                <div key={object.id}>
                  <FlipCard
                    svg = {object.svg}
